...
// Mendapatkan peristiwa penting secara baris per baris (Ada beberapa perubahan seperti perapian koding dengan tujuan menghindari error >x<
    public void getPeristiwaBarisPerBaris(LocalDate tanggal, JTextArea txtAreaPeristiwa, Supplier<Boolean> shouldStop) throws Exception { 
        try {
